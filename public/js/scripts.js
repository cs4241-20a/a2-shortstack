...
document.body.addEventListener( 'click', function ( event ) {
  ...
  if(event.path[1].className === 'delete') {
    ...
    `
    const discardOrConfirm = `<button class="confirm" name=${targetISBN}><i class="far fa-check-circle"></i></button> <button class="discard" name=${targetISBN}><i class="far fa-times-circle"></i></button>`  
