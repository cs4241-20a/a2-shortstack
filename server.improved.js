...
const handlePost = function(request, response) {
  ...
  request.on("end", function() {
    ...
    db.put({
      ...
      favarite_game: JSON.stringify(json.favarite_game),
      game_cost: JSON.stringify(json.game_cost),
      hours_played: JSON.stringify(json.hours_played),
      cost_per_hour: JSON.stringify(json.cost_per_hour)
    });
